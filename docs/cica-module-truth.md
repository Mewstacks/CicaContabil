...
| Triagem de Arquivos | Módulo registrado, rota e página vazia; nenhuma leitura de e-mail, extração ou arquivamento ainda existe | Não conecta caixa de e-mail, não classifica e não arquiva nenhum documento | Nenhum texto público até a primeira frente funcional ser entregue |
