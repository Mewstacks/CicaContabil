...
10. [Operação Asaas](asaas-operacao.md) separa o receptor de webhook já implementado da criação de cobranças e da homologação ainda pendente.
11. [Operação do Radar da Reforma](radar-operacao.md) registra a coleta existente, o estado mostrado ao escritório e as provas locais sem ampliar a promessa do módulo.
12. [Ativação operacional da IA](ia-operacao.md) registra a chave central, controles, contagem gratuita e uma geração sintética real autorizada sem armazenar segredo.
13. [Conexão das caixas de e-mail](conexao-caixas-email.md) define a jornada simples do escritório, a preparação OAuth central da Mewstack, a exigência de verificação Google e as provas ainda necessárias.
