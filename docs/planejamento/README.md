...
**Atualização V-099:** a demonstração isolada da Conciliação passou por inspeção local em desktop e celular, sem overflow horizontal ou erros de console; não houve upload, integração, cobrança ou homologação.
