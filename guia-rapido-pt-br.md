...
Consulte o passo a passo completo em [deployment-fly.md](deployment-fly.md).
...
Antes de receber dados reais, revise também [security.md](security.md), [lgpd.md](lgpd.md) e os
