...
class CICAAuthFlowTests(TestCase):
        ...
        with sync_playwright() as playwright:
            ...
            for name in pages:
                ...
                for width in [1440, 390]:
                    ...
                    if name != "mfa-setup":
                        page.screenshot(
                            path=str(Path(gettempdir()) / f"cica-auth-{name}-{width}.png")
                        )
            current[0] = "login"
            page.goto("http://cica.test/login")
            ...
            current[0] = "proposal"
            page.goto("http://cica.test/proposta/")
            ...
            page.screenshot(path=str(Path(gettempdir()) / "cica-auth-cnpj-found.png"))
