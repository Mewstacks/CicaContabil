...
urlpatterns = [
    ...
    path("app/jornada/", views.journey, name="journey"),
    path("app/jornada/etapas/", views.create_journey_step, name="journey-step-create"),
    path("app/jornada/solicitacoes/", views.create_portal_request, name="portal-request-create"),
    path(
        "app/jornada/etapas/concluir/",
        views.complete_journey_step,
        name="journey-step-complete",
    ),
    path(
        "app/jornada/solicitacoes/atualizar/",
        views.transition_portal_request,
        name="portal-request-transition",
    ),
